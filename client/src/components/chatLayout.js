        ...
        <>
            <div id="frame">
                <div id="sidepanel">
                    <div id="profile">
                        <div className="wrap">
                            <img id="profile-img" src="http://emilcarlsson.se/assets/mikeross.pngnk" className="online" alt="" />
                            <p>{ user.name }</p>
                        </div>
                    </div>
                    {/* <div id="search">
                    ...
                    <Contacts />
                    <div id="bottom-bar">
                        <button id="logout" onClick={logOutAction} style={{width:'100%'}}><span>Déconnexion</span></button>
                        </div>
                </div>
